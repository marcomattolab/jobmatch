...
import { CompanySectorComponent } from 'app/entities/company-sector/company-sector.component';
...
describe('Component Tests', () => {
    describe('CompanySector Management Component', () => {
        let comp: CompanySectorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CompanySectorComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CompanySectorComponent, '')
                .compileComponents();
