...
import { AppliedJobComponent } from 'app/entities/applied-job/applied-job.component';
...
describe('Component Tests', () => {
    describe('AppliedJob Management Component', () => {
        let comp: AppliedJobComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AppliedJobComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.applyments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
