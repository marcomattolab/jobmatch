...
import { JobOfferSkillComponent } from 'app/entities/job-offer-skill/job-offer-skill.component';
...
describe('Component Tests', () => {
    describe('JobOfferSkill Management Component', () => {
        let comp: JobOfferSkillComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [JobOfferSkillComponent],
                providers: [
                    {
                ...
                .overrideTemplate(JobOfferSkillComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.jobOfferSkills[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
