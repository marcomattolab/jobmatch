...
import { SkillTagComponent } from 'app/entities/skill-tag/skill-tag.component';
...
describe('Component Tests', () => {
    describe('SkillTag Management Component', () => {
        let comp: SkillTagComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SkillTagComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.skillTags[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
