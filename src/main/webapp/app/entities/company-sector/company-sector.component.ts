...
@Component({
    selector: 'jhi-company-sector',
    templateUrl: './company-sector.component.html'
})
export class CompanySectorComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.companySectorService
            ...
            .subscribe(
                (res: HttpResponse<ICompanySector[]>) => this.paginateCompanySectors(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/company-sector'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ICompanySector) {
        return item.id;
    }
    ...
    protected paginateCompanySectors(data: ICompanySector[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.companySectors = data;
    }
