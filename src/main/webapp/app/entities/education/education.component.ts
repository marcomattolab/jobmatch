...
export class EducationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.educationService
            ...
            .subscribe(
                (res: HttpResponse<IEducation[]>) => this.paginateEducations(res.body, res.headers),
    ...
    trackId(index: number, item: IEducation) {
        return item.id;
    }
    ...
    protected paginateEducations(data: IEducation[], headers: HttpHeaders) {
