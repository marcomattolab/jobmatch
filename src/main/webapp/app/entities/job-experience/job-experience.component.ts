...
export class JobExperienceComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.jobExperienceService
            ...
            .subscribe(
                (res: HttpResponse<IJobExperience[]>) => this.paginateJobExperiences(res.body, res.headers),
    ...
    trackId(index: number, item: IJobExperience) {
        return item.id;
    }
    ...
    registerChangeInJobExperiences() {
        this.eventSubscriber = this.eventManager.subscribe('jobExperienceListModification', response => this.loadAll());
    }
    ...
    protected paginateJobExperiences(data: IJobExperience[], headers: HttpHeaders) {
