...
export class JobOfferComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.jobOfferService
            ...
            .subscribe(
            ( res: HttpResponse<IJobOffer[]> ) => this.paginateJobOffers( res.body, res.headers ),
    ...
    trackId( index: number, item: IJobOffer ) {
        return item.id;
    }
    ...
    protected paginateJobOffers( data: IJobOffer[], headers: HttpHeaders ) {
