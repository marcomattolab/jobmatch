...
@Component({
    ...
    templateUrl: './candidate-delete-skill-dialog.component.html'
})
export class CandidateDeleteSkillDialogComponent {
    skill: ISkill;
...
export class CandidateDeleteSkillPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ skill }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(CandidateDeleteSkillDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
