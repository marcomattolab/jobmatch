...
export class JhiAlertErrorComponent implements OnDestroy {
    ...
    constructor( private alertService: JhiAlertService, private eventManager: JhiEventManager, private translateService: TranslateService ) {
        ...
        this.cleanHttpErrorListener = eventManager.subscribe( 'jobmatchApp.httpError', response => {
            let i;
                ...
                case 400:
                    ...
                    if ( errorHeader ) {
                        ...
                        for ( i = 0; i < fieldErrors.length; i++ ) {
                            ...
                            const objectName = this.endsWith( fieldError.objectName, 'DTO' ) ? fieldError.objectName.replace( 'DTO', '' ) : fieldError.objectName;
                            const fieldName = translateService.instant( 'jobmatchApp.' + objectName + '.' + convertedField );
