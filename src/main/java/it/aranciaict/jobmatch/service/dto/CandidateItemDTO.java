...
public class CandidateItemDTO implements Serializable {
	...
	/** The current job experience. */
	private JobExperienceDTO currentJobExperience;
	...
	public boolean equals(Object o) {
		...
		CandidateItemDTO candidateDTO = (CandidateItemDTO) o;
	 ...
	 */
	public JobExperienceDTO getCurrentJobExperience() {
		return currentJobExperience;
	}

	/**
	 * Sets the current job experience.
	 *
	 * @param currentJobExperience the new current job experience
	 */
	public void setCurrentJobExperience(JobExperienceDTO currentJobExperience) {
	...
	public String toString() {
		return "CandidateItemDTO [id=" + id + ", createdBy=" + createdBy + ", lastModifiedBy=" + lastModifiedBy
				...
				+ cap + ", enabled=" + enabled + ", userId=" + userId + ", userName=" + userName + "]";
	}
