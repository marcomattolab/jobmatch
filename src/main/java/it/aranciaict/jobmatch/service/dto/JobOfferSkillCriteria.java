...
/**
 * Criteria class for the JobOfferSkill entity. This class is used in JobOfferSkillResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /job-offer-skills?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@SuppressWarnings("serial")
public class JobOfferSkillCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final JobOfferSkillCriteria that = (JobOfferSkillCriteria) o;
        return
